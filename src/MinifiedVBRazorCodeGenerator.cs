namespace HtmlMinifier
{
    ...
    internal class MinifiedVBRazorCodeGenerator : MvcVBRazorCodeGenerator
    {
        public MinifiedVBRazorCodeGenerator(string className, string rootNamespaceName, string sourceFileName, RazorEngineHost host)
